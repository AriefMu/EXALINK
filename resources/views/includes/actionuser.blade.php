    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body" id="modalbody">
          <form action="{{ route('pinjam.update',$row->id) }}" method="POST" enctype="multipart/form-data">
...
<div class="row">
  ...
  <div class="row">
            <div class="col">
              <textarea class="form-control" id="alasan" name="alasan" rows="4" cols="20" disabled>{{$row->alasan}}</textarea>
            </div>
          </div>
